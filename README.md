...
> Motor principal de [AwiTa-MD](https://github.com/Gerard0Tx/AwiTaBot-MD) — todas las funciones de manera remota, privada, y rapida.

---

## 🧪 ¿Qué es?

`@awita/scraper` es el núcleo que le da vida a la bot AwiTa-MD.  
Contiene **todas** las funciones que la bot utiliza a diario:  
